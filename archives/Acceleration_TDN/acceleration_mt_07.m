...
r_pat = 5000; % Regime de patinage de l'embrayage (tr/min)
...
% Moteur MT-07: courbe de couple

rmot=[0 2600 2800 3000 3200 3400 3600 3800 4000 4200 4400 4600 4800 5000 5200 5400 5600 5800 6000 6200 6400 6600 6800 7000 7200 7400 7600 7800 8000 8200 8400 8600 8800 9000 9200 9400 9600 9800 10000 10200];
cmot=[50.84 50.84 51.52 51.66 53.28 54.36 56.00 55.72 56.94 56.94 58.30 58.98 58.98 59.66 60.06 61.42 61.42 61.28 60.47 60.33 60.20 59.93 59.66 59.25 59.11 58.30 56.94 56.27 54.36 52.87 52.20 51.25 49.76 47.45 46.1 44.74 43.39 42.03 37.96]*0.1;


r_rupteur = 10000; % Regime de rupteur (tr/min)
t_pas = 0.06; % Temps de passage de rapport (s)

% Transmission
k_p = 1/1.925; % Rapport primaire

% Etagement origine
K(1) = 1/2.846; % Rapport de 1ere
K(2) = 1/2.125; % Rapport de 2eme
K(3) = 1/1.632; % Rapport de 3eme
K(4) = 1/1.3; % Rapport de 4eme

k_f = 1/3; % Rapport final
